...
Instance Type: t3.medium or larger\\
Storage: Shared storage using FSx for Windows, S3, or iSCSI (Internet Small Computer Systems Interface)\\
Network: Placement groups for low latency\\
Security Group:
\begin{itemize}
	\item Allow cluster communication ports
	\item tcp 3389 (RDP)
\end{itemize}
...
# ---- 4. Configure cluster networks ----
Write-Host "Configuring cluster network settings..." -ForegroundColor Cyan
Get-ClusterNetwork | Set-ClusterNetwork -AutoMetric 1
          
# ---- 5. Add disks & enable CSV ----
